...
public class SignUp {
    ...
    @PostMapping("/signup")
    public ResponseEntity<Object> signup(@RequestBody @Validated({SignUpRequest.Create.class, Default.class}) SignUpRequest signupRequest, BindingResult bindingResult) {
